...
<body class="bodycolor">
  ...
  <input type="hidden" name="savetype" value="add" />
    ...
    <table class="table table-bordered table-hover" id="first">
        ...
        <tbody>
              <?php if( count($array_infos) > 0 ) {?>
                  <?php   $js = 1; ?>
                  <?php foreach($array_infos as $key=>$value):?>
                   
                  <tr>
                    <td style="text-align:center;vertical-align: middle;"> <?=$js?> </td>

                    <td style="text-align:center;vertical-align: middle;">
                      <?=get_realname($value['base']['user_id'])?>
                        <input type="hidden" name="uid[]" value="<?=$value['base']['user_id'];?>">
                    </td>

                    <td style="text-align:center;vertical-align: middle;">
                      <?php echo get_realdepaname($value['base']['department_id']);?>
                        <input type="hidden" name="departmentName[]" value="<?=$value['base']['department_id']?>">
                    </td>

                    <td style="text-align:center;vertical-align: middle;">月度</td>
                    <td style="text-align:center;vertical-align: middle;">
                      <?=$key[0]?>
                        <input type="hidden" name="month[]" value="<?=$key[0]?>"> 
                    </td>

                    <td style="text-align:center;vertical-align: middle;">
                      <input type="text" name="firstWeekWeight[]" placeholder="第一周权重">
                      <input type="hidden" name="wekid[]" value="<?=$value['data'][1]['id']?>">
                    </td>

                    <td style="text-align:center;vertical-align: middle;">
                      <input type="text" name="firstWeekScore[]" readonly="readonly" value="<?=$value['data'][1]['score']?>">
                    </td>

                    <td style="text-align:center;vertical-align: middle;">
                      <input type="text" name="secondWeekWeight[]" placeholder="第二周权重">
                      <input type="hidden" name="wekid[]" value="<?=$value['data'][2]['id']?>">
                    </td>
                    <td style="text-align:center;vertical-align: middle;">
                        <input type="text" name="secondWeekScore[]" readonly="readonly" value="<?=$value['data'][2]['score']?>">
                    </td>

                    <td style="text-align:center;vertical-align: middle;">
                      <input type="text" name="thirdWeekWeight[]" placeholder="第三周权重">
                      <input type="hidden" name="wekid[]" value="<?=$value['data'][3]['id']?>">
                    </td>
                    <td style="text-align:center;vertical-align: middle;">
                      <input type="text" name="thirdWeekScore[]" readonly="readonly" value="<?=$value['data'][3]['score']?>">
                    </td>

                    <td style="text-align:center;vertical-align: middle;">
                      <input type="text" name="fourthWeekWeight[]" placeholder="第四周权重">
                      <input type="hidden" name="wekid[]" value="<?=$value['data'][4]['id']?>">
                    </td>
                    <td style="text-align:center;vertical-align: middle;">
                       <input type="text" name="fourthWeekScore[]" readonly="readonly" value="<?=$value['data'][4]['score']?>">
                    </td>

                    <td style="text-align:center;vertical-align: middle;">
                      <input type="text" name="fifthWeekWeight[]" placeholder="第五周权重">
                      <input type="hidden" name="wekid[]" value="<?=$value['data'][5]['id']?>">
                    </td>
                    <td style="text-align:center;vertical-align: middle;">
                       <input type="text" name="fifthWeekScore[]" readonly="readonly" value="<?=$value['data'][5]['score']?>">
                    </td>

                    <td style="text-align:center;vertical-align: middle;">
                       <input type="text" name="managerContent[]" placeholder="总经理评价">
                    </td>

                    <td style="text-align:center;vertical-align: middle;"></td>
                    <td style="text-align:center;vertical-align: middle;">
                   
                    <input type="text" name="monthpreg[]" placeholder="本月权重">
                    </td>
                    <td style="text-align:center;vertical-align: middle;"></td>
              </tr>
                 <?php   $js++; ?>
