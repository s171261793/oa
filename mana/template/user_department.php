...
<div id="content" class="ui-content fn-clear" coor="default" coor-rate="0.02">
		...
		<div class="ui-grid-21 ui-grid-right fn-clear" coor="total">
		                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                          <tr>
                                            ...
                                            <td width="9%" align="right" style="padding-right:10px;"><input type="button" value="新增账号" class="BigButtonBHover" onClick="javascript:window.location='admin.php?ac=user&fileurl=mana&do=add'"></td>
                                          </tr>
                                        </table>
	...
	<form name="excel" method="post" action="admin.php?ac=user&fileurl=mana">
	...
	<form name="update" method="post" action="admin.php?ac=user&fileurl=mana">
						...
						<table id="tradeRecordsIndex" class="ui-table">
							...
							<thead>
								<tr>
									...
									<th class="checkbox">序号</th>
									<th class="title">用户名</th>
									<th class="info">用户编号</th>
...
<td class="checkbox"><input name="numbers[<?php echo $row['id'];?>]" type="text" style="width:30px;" value="<?php echo ($key+1)?>" /></td>

<td class="title">
<ul><li class="name"><?php echo $row['username']?></li>
<li class="no J-bizNo">	<?php echo get_groupname($row['groupid'])?></li></ul>
</td>
<td class="title"><?php echo $row['usercode']?></td>
<td class="title"><?php echo $row['create_time']?></td>
...
<a href="admin.php?ac=user&fileurl=mana&do=add&id=<?php echo $row['id']?>">编辑</a>
<? }?>
</td>
